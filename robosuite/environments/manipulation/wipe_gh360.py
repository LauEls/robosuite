...
DEFAULT_WIPE_CONFIG = {
    ...
    "table_full_size": [0.8, 0.5, 0.05],  # Size of tabletop
    "table_offset": [-0.3274, 0.4, 1.06],  # Offset of table (z dimension defines max height of table)
...
class WipeGH360(SingleArmEnv):
    ...
    def __init__(
        ...
        gripper_types="WipingGripperGH360",
    ...
    def _post_action(self, action):
        ...
        # print("recent_wrench", self.robots[0].recent_ee_forcetorques.current)
        # print("total_wrench_ee: ", total_wrench_ee)
